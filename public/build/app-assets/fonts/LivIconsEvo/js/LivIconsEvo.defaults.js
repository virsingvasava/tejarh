...
var url = customurl+'/build/app-assets/fonts/LivIconsEvo/svg/';
...
function LivIconsEvoDefaults() {
	...
	var defaultOptions = {
		...
		pathToFolder: customurl+'/build/app-assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
		//pathToFolder: 'http://127.0.0.1:8000/build/app-assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
