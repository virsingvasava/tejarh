      ...
      <div class="content-header row">
         <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
               <h5 class="content-header-title float-left pr-1 mb-0">@lang('messages.faq_category.faq_category')</h5>
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     <li class="breadcrumb-item"><a href="/admin"><i class="bx bx-home-alt"></i></a>
                     </li>
                     <li class="breadcrumb-item active">@lang('messages.faq_category.faq_category_list')
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.faqs.faqs_category.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                     <i class="bx bx-plus"></i>
                     <span class="invoice-repeat-btn">@lang('messages.faq_category.add_faq_category')</span>
                     </a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body card-dashboard"> 
                        <div class="table-responsive">
                            @if (App::isLocale('en'))
                               <table class="table zero-configuration" id="faq_category_english_table">
                            @else
                               <table class="table zero-configuration" id="faq_category_arabic_table">
                            @endif
                              <thead>
                                 <tr>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.faqs.faqs_category.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                          <a class="dropdown-item" href="{{route('admin.faqs.faqs_category.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
                              ...
                              @else
                              <tr>
                                 <td colspan="10">@lang('messages.faq_category.not_found_faq_category')</td>
                              </tr>
                              @endif
                           </table>
                        </div>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="tejarhModalCenterTitle">@lang('messages.common.ary_you_sure')</h5>
         ...
         <div class="modal-body">
            <p class="mb-0">
               <strong>@lang('messages.faq_category.are_you_sure_delete_faq_category')</strong>
            </p>
         </div>
         <form action="{{route('admin.faqs.faqs_category.destroy')}}" method="POST">
            @csrf
...
$(document).ready(function(){
    $('.js-switch').change(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route('admin.faqs.faqs_category.faq_category_status_update') }}',
            data: {'status': status, 'category_id': category_id, _token:token},
