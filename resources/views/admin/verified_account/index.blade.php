                              ...
                              <table class="table zero-configuration" id="user_arabic_table">
                                 ...
                                 <thead>
                                    <tr>
                                       ...
                                       <th>@lang('messages.user.status')</th>
                                       <th>@lang('messages.common.action')</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    @if(!empty($verify) && count($verify) > 0)
                                       ...
                                       <td>
                                          <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{route('admin.user.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>
                                                <!-- <a class="dropdown-item" href="{{route('admin.user.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a> -->
