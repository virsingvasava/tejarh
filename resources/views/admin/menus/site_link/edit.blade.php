      ...
      <div class="content-header row">
         <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
               <h5 class="content-header-title float-left pr-1 mb-0">@lang('messages.menus.site_link.create.site_link')</h5>
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     <li class="breadcrumb-item"><a href="/admin"><i class="bx bx-home-alt"></i></a>
                     </li>
                     <li class="breadcrumb-item"><a href="{{route('admin.menus.site_link.index')}}">@lang('messages.menus.site_link.create.site_links')</a>
                     </li>
                     <li class="breadcrumb-item active">@lang('messages.menus.site_link.edit.edit')
                     </li>
                  </ol>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form  action="{{route('admin.menus.site_link.update')}}" enctype="multipart/form-data" method="post" id="site_links_edit">
                           @csrf
                           <input type="hidden" name="id" value="{{$edit_menu->id}}">
                           <input type="hidden" name="type" value="{{$edit_menu->type}}">
                           <div class="form-row">
                              <div class="col-md-6 mb-6">
                                 <label for="name">@lang('messages.menus.site_link.name')</label>
                                 <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{$edit_menu->name}}" placeholder="@lang('messages.menus.site_link.create.enter_name')">
                                 @error('name')
                              ...
                              <div class="col-md-6 mb-6">
                                 <label for="url">@lang('messages.menus.site_link.url')</label>
                                 <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" id="url" value="{{$edit_menu->url}}" placeholder="@lang('messages.menus.site_link.create.enter_url')">
                           ...
                           <a href="{{route('admin.menus.site_link.index')}}" class="btn btn-light-secondary btn_loader">@lang('messages.common.reset')</a>
                        </form>
                     </div>
                  </div>
               </div>
