            ...
            <div class="breadcrumbs-top">
               ...
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     ...
                     <li class="breadcrumb-item"><a href="{{route('admin.menus.useful_link.index')}}">@lang('messages.menus.useful_link.create.useful_links')</a>
                     </li>
                     <li class="breadcrumb-item active">@lang('messages.menus.useful_link.create.create')
                     </li>
                  </ol>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form  action="{{route('admin.menus.useful_link.store')}}" enctype="multipart/form-data" method="post" id="useful_links_create">
                           @csrf
                           <div class="form-row">
                              <input type="hidden" name="type" value="3">
                              <div class="col-md-6 mb-6">
                                 <label for="name">@lang('messages.menus.useful_link.name')</label>
                                 <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="@lang('messages.menus.useful_link.create.enter_name')">
                                 @error('name')
                              ...
                              <div class="col-md-6 mb-6">
                                 ...
                                 <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" value="{{old('url')}}" id="url" placeholder="@lang('messages.menus.useful_link.create.enter_url')">
                              </div>
                              <div class="col-md-6 mb-6">
