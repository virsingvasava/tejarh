                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                            <li class="breadcrumb-item"><a href="{{route('admin.product.index')}}"><i class="bx bx-home-alt"></i>@lang('messages.product.product_list')</a>
                            </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">@lang('messages.product.detail')</h4>
                            </div>
                            <div class="card-body card-dashboard">
                                <div class="table-responsive">
                                    <table class="table zero-configuration or-view">
                                        <tbody>
                                            <tr>
                                                <th>@lang('messages.product.product_created_by')</th>
                                                <td>{{ $view_user->first_name }}</td>
                                            </tr>
                                            <tr>
                                                <th>@lang('messages.product.product_created')</th>
            ...
            <section>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">@lang('messages.product.product_details')</h4>
                            </div>
                            <div class="card-body card-dashboard">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@lang('messages.product.create.delivery_type')</th>
                                                ...
                                                <th>@lang('messages.product.view.width')</th>
                                                <th>@lang('messages.product.view.length')</th>
                                                <th>@lang('messages.product.view.height')</th>
                                            </tr>
                                        </thead>
                                        <tr>
                                            ...
                                            <td>{{$view_products->address}}</td>
                                            <td>{{$view_delivey_type->name}}</td>
                                            ...
                                            <td>{{ucfirst($view_products->width)}}</td>
                                            <td>{{ucfirst($view_products->length)}}</td>
                                            <td>{{ucfirst($view_products->height)}}</td>
                                        </tr>
            ...
            <section>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">@lang('messages.product.product_images')</h4>
                            </div>
                            <div class="card-body card-dashboard">
