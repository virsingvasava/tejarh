      ...
      <div class="content-header row">
         <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
               <h5 class="content-header-title float-left pr-1 mb-0">@lang('messages.delivery_type.delivery_types')</h5>
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"><i class="bx bx-home-alt"></i></a>
                     </li> 
                     <li class="breadcrumb-item active">@lang('messages.delivery_type.delivery_type_list')
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.delivery_type.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                     <i class="bx bx-plus"></i>
                     <span class="invoice-repeat-btn">@lang('messages.delivery_type.add_delivery_type')</span>
                     </a>
                  </div>
               </div>
            </div>
                     ...
                     <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            ...
                            @endif
                              ...
                              @if(!empty($deliveryType) && count($deliveryType) > 0)
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.delivery_type.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                          <a class="dropdown-item" href="{{route('admin.delivery_type.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
                              ...
                              @else
                              <tr>
                                 <td colspan="10">@lang('messages.delivery_type.not_found_delivery_type')</td>
                              </tr>
                              @endif
                           </table>
                        </div>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p class="mb-0">
               <strong>@lang('messages.delivery_type.are_you_sure_delete_delivery_type')</strong>
            </p>
         </div>
         <form action="{{route('admin.delivery_type.destroy')}}" method="POST">
            @csrf
            <input type="hidden"  name="delivery_type_id" class="delivery_type_id">
...
$(document).ready(function(){
    $('.js-switch').change(function () {
        ...
        let delivery_type_id = $(this).data('id');
        var token = "{{csrf_token()}}";
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route("admin.delivery_type.delivery_type_status_update") }}',
            data: {'status': status, 'delivery_type_id': delivery_type_id, _token:token},
