      ...
      <div class="content-header row">
         <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
               <h5 class="content-header-title float-left pr-1 mb-0">@lang('messages.condition.conditions')</h5>
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     <li class="breadcrumb-item"><a href="/admin"><i class="bx bx-home-alt"></i></a>
                     </li> 
                     <li class="breadcrumb-item active">@lang('messages.condition.condition_list')
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.condition.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                     <i class="bx bx-plus"></i>
                     <span class="invoice-repeat-btn">@lang('messages.condition.add_condition')</span>
                     </a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            @if (App::isLocale('en'))
                               <table class="table zero-configuration" id="condition_english_table">
                            @else
                               <table class="table zero-configuration" id="condition_arabic_table">
                            @endif
                              <thead>
                                 <tr>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.condition.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                          <a class="dropdown-item" href="{{route('admin.condition.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
                              ...
                              @else
                              <tr>
                                 <td colspan="10">@lang('messages.condition.not_found_conditions')</td>
                              </tr>
                              @endif
                           </table>
                        </div>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p class="mb-0">
               <strong>@lang('messages.condition.are_you_sure_delete_conditions')</strong>
            </p>
         </div>
         <form action="{{route('admin.condition.destroy')}}" method="POST">
            @csrf
            <input type="hidden"  name="condition_id" class="condition_id">
...
$(document).ready(function(){
    $('.js-switch').change(function () {
        ...
        let condition_id = $(this).data('id');
        var token = "{{csrf_token()}}";
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route('admin.condition.condition_status_update') }}',
            data: {'status': status, 'condition_id': condition_id, _token:token},
...
$(document).on('click','.tejarh_delete_button',function(){
    ...
    $('.condition_id').val($(this).attr('data-id'));
})
