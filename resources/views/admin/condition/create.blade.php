            ...
            <div class="breadcrumbs-top">
               ...
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     ...
                     <li class="breadcrumb-item active">@lang('messages.condition.create.create')
                     </li>
                  </ol>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form  action="{{route('admin.condition.store')}}" enctype="multipart/form-data" method="post" id="condition_create">
                           @csrf
                           <div class="form-row">
                              <!-- <div class="col-md-12 mb-12">
                                 <label for="status">@lang('messages.condition.select_brand')</label>
                                 <fieldset class="form-group">
                                    <select class="custom-select @error('brand_id') is-invalid @enderror" 
                                    name="brand_id">
                                       <option value="">@lang('messages.condition.select_brand')</option>
                              ...
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="@lang('messages.condition.create.enter_name')">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                              ...
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    <label for="name">@lang('messages.common.ar_name')</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="@lang('messages.condition.create.enter_name')">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
