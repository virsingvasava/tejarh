                        ...
                        <div class="table-responsive">
                           <table class="table zero-configuration">
                              ...
                              <tr>
                                 <td>{{ $value['sku_id'] }}</td>
                                 <td>{{ $value['subject'] }}</td>
                                 <td>{{ $value['supportCategory']['support_category_name'] }}</td>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          <a class="dropdown-item" href="{{route('admin.ticket.view',($value['id']))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>
                                       </div>
                                    </div>
                                 </td>
                              </tr>
   ...
   $(document).ready(function() {
      $('.js-switch').change(function() {
         ...
         $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route("admin.ticket.status_update") }}',
            data: {
               'status': status,
               'ticket_id': ticket_id,
               _token: token
