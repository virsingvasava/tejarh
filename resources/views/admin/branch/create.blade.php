            ...
            <div class="breadcrumbs-top">
               ...
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     ...
                     <li class="breadcrumb-item active">@lang('messages.branch.create.create')
                     </li>
                  </ol>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form  action="{{route('admin.branch.store')}}" enctype="multipart/form-data" method="post" id="branch_create">
                           @csrf
                           <div class="form-row">
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    <label for="name">@lang('messages.common.eng_name')</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="@lang('messages.branch.create.enter_name')">
                                    @error('name')
                              ...
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('ar_name') is-invalid @enderror" name="ar_name" id="ar_name" value="{{old('ar_name')}}" placeholder="@lang('messages.branch.create.enter_name')">
                                    @error('ar_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                              ...
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('ar_slug') is-invalid @enderror" name="ar_slug" id="ar_slug" value="{{old('ar_slug')}}" placeholder="@lang('messages.branch.create.enter_slug')">
                                    @error('ar_slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
