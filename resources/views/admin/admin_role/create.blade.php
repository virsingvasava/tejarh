                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.admin_role.store')}}" enctype="multipart/form-data" method="post" id="role_create">
                                    @csrf
                                    <div class="form-row">
                                        <div class="col-md-12 mb-6">
                                            <div class="d-block mb-1">
                                                <label for="role">Rloe</label>
                                                <input type="text" class="form-control" name="name" id="role" placeholder="Enter Permission">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-6">
