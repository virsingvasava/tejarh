                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-12 col-sm-3 text-center mb-1 mb-sm-0">
                                                                <img src="{{asset('build/app-assets/images/portrait/small/avatar-s-16.jpg')}}" class="rounded" alt="group image" height="120" width="120" />
                                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-inline-flex">
                                            <div class="avatar mr-50">
                                                <img src="{{asset('build/app-assets/images/portrait/small/avatar-s-20.jpg')}}" alt="avtar images" height="32" width="32">
                                            </div>
                                            <h6 class="mb-0 d-flex align-items-center"> Nile's Birthday!</h6>
                                        </div>
                                        <i class="cursor-pointer bx bx-dots-vertical-rounded float-right"></i>
                                        <div class="user-profile-birthday-image text-center p-2">
                                            <img class="img-fluid" src="{{asset('build/app-assets/images/profile/pages/birthday.png')}}" alt="image">
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media d-flex align-items-center mb-1">
                                            <a href="JavaScript:void(0);">
                                                <img src="{{asset('build/app-assets/images/banner/banner-30.jpg')}}" class="rounded" alt="group image" height="64" width="64" />
                                            </a>
                                        ...
                                        <div class="media d-flex align-items-center mb-1">
                                            <a href="JavaScript:void(0);">
                                                <img src="{{asset('build/app-assets/images/banner/banner-31.jpg')}}" class="rounded" alt="group image" height="64" width="64" />
                                            </a>
                                            <div class="media-body ml-1">
                                        ...
                                        <div class="media d-flex align-items-center">
                                            <a href="JavaScript:void(0);">
                                                <img src="{{asset('build/app-assets/images/banner/banner-32.jpg')}}" class="rounded" alt="group image" height="64" width="64" />
                                            </a>
                                            <div class="media-body ml-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-10.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-11.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-12.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-13.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-05.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-06.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-07.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-08.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                            <div class="col-md-4 col-6 pl-25 pr-0 pb-25">
                                                <img src="{{asset('build/app-assets/images/profile/user-uploads/user-09.jpg')}}" class="img-fluid" alt="gallery avtar img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
