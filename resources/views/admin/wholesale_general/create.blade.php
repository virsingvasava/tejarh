                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                            ...
                            <li class="breadcrumb-item active">@lang('messages.wholesale_general.create.create')
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.wholesale_general.store')}}" enctype="multipart/form-data" method="post" id="wholesale_general_create">
                                    @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            <div class="d-block mb-1">
                                                ...
                                                <input type="text" class="form-control @error('ar_title') is-invalid @enderror" name="ar_title" id="ar_title" value="{{old('ar_title')}}" placeholder="@lang('messages.general.create.enter_name')">
                                                @error('ar_title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                                ...
                                                <fieldset class="form-label-group">
                                                    <textarea class="form-control @error('description')
                                                     is-invalid @enderror" name="description"
                                                      ...
                                                      placeholder="@lang('messages.wholesale_general.create.enter_description')"></textarea>
                                                    @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6 mb-6">
                                            <div class="form-group">
                                                <label>@lang('messages.wholesale_general.create.wholesale_general_picture')</label> <br>
                                                <input type="file" name="wholesale_general_image" class="wholesale_general_image" 
                                                onclick="offerBannerImageUpload()" accept="image/*" id="upload" hidden />
                                                <label class="image_upload_btn" for="upload">@lang('messages.wholesale_general.create.choose_file')</label>
                                                <div class="d-block mt-1"><img id="wholesale_general_image_preview"
...
<script type="text/javascript">
    $(document).on('change', '.wholesale_general_image', function() {
        $('#wholesale_general_image_preview').hide();
        readURL(this);
    });
    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                $('#wholesale_general_image_preview').attr('src', e.target.result);
                $('#wholesale_general_image_preview').show();
            }
