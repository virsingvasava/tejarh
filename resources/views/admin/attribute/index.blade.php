            ...
            <div class="breadcrumbs-top">
               ...
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     ...
                     <li class="breadcrumb-item active">Attribute_list
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.attribute.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                        <i class="bx bx-plus"></i>
                        <span class="invoice-repeat-btn">add_attribute</span>
                     </a>
                  </div>
               </div>
            </div>
                              ...
                              <table class="table zero-configuration" id="brand_arabic_table">
                                 ...
                                 <thead>
                                    <tr>
                                       ...
                                       <th>English Sub Category Name</th>
                                       <th>Arabic Sub Category Name</th>
                                 ...
                                 <tr>
                                    ...
                                    <td>{{$value->ar_category_name}}</td>

                                    <td>{{$value->sub_cate_name}}</td>
                                    <td>{{$value->ar_sub_cate_name}}</td>
                                    ...
                                    <td>
                                       <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right">
                                             ...
                                             <a class="dropdown-item" href="{{route('admin.attribute.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                             <a class="dropdown-item" href="{{route('admin.attribute.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
                                 ...
                                 @else
                                 <tr>
                                    <td colspan="10">Not Found Attribute</td>
                                 </tr>
                                 @endif
                              </table>
                        </div>
   ...
   $(document).ready(function() {
      $('.js-switch').change(function() {
         ...
         $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('admin.attribute.attribute_status_update') }}",
            data: {
               'status': status,
