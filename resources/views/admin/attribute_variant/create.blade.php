                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.attribute.index')}}">Attribute - Variant</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.attribute_variant.store')}}" enctype="multipart/form-data" method="post" id="brand_create">
                                    @csrf
                                    <div class="form-row">
