                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.permission.update')}}" enctype="multipart/form-data" method="post" id="role_create">
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-6">
                                            <div class="d-block mb-1">
                                                ...
                                                <input type="text" class="form-control" name="Permission_name" id="Permission"  placeholder="Enter Permission" value="{{$permission->name}}">
                                            </div>
                                        </div>
                                    </div>
