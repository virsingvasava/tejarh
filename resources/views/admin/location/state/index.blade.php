            ...
            <div class="breadcrumbs-top">
               ...
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     ...
                     <li class="breadcrumb-item active">@lang('messages.location.state.state_list')
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.location.state.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                     <i class="bx bx-plus"></i>
                     <span class="invoice-repeat-btn">@lang('messages.location.state.add_state')</span>
                     </a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            @if (App::isLocale('en'))
                               <table class="table zero-configuration" id="state_english_table">
                            @else
                               <table class="table zero-configuration" id="state_arabic_table">
                            @endif
                              <thead>
                                 <tr>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.location.state.view_state',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                          <a class="dropdown-item" href="{{route('admin.location.state.edit_state',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
                              ...
                              @else
                              <tr>
                                 <td colspan="10">@lang('messages.location.state.not_found_state')</td>
                              </tr>
                              @endif
                           </table>
                        </div>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p class="mb-0">
               <strong>@lang('messages.location.state.are_you_sure_delete_state')</strong>
            </p>
         </div>
         <form action="{{route('admin.location.state.destroy_state')}}" method="POST">
            @csrf
...
$(document).ready(function(){
    $('.js-switch').change(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route('admin.location.state.state_status_update') }}',
            data: {'status': status, 'state_id': state_id, _token:token},
