            ...
            <div class="breadcrumbs-top">
               ...
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     ...
                     <li class="breadcrumb-item"><a href="{{route('admin.menus.useful_link.index')}}">@lang('messages.location.city.city_list')</a>
                     </li>
                           ...
                           <table class="table zero-configuration or-view">
                              <tbody>
                                 <tr>
                                    ...
                                    <td>{{$view_city->name}}</td>
                                 </tr>
                                 <tr>
                                    <th>@lang('messages.location.city.slug')</th>
                                    <td>{{$view_city->slug}}</td>
                                 </tr>
                                 <tr>
                                    <th>@lang('messages.common.status')</th>
                                    <td>
                                       @if($view_city->status == 1)
