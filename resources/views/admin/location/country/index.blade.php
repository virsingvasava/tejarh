      ...
      <div class="content-header row">
         <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
               <h5 class="content-header-title float-left pr-1 mb-0">@lang('messages.location.country.countries')</h5>
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     <li class="breadcrumb-item"><a href="/admin"><i class="bx bx-home-alt"></i></a>
                     </li>
                     <li class="breadcrumb-item active">@lang('messages.location.country.country_list')
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.location.country.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                     <i class="bx bx-plus"></i>
                     <span class="invoice-repeat-btn">@lang('messages.location.country.add_country')</span>
                     </a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body card-dashboard">
                        <div class="table-responsive">
                            @if (App::isLocale('en'))
                               <table class="table zero-configuration" id="country_english_table">
                            @else
                               <table class="table zero-configuration" id="country_arabic_table">
                            @endif
                              <thead>
                                 <tr>
                                    <th>@lang('messages.common.sr_no')</th>
                                    <!-- <th>@lang('messages.location.country.code')</th> -->
                                    <th>@lang('messages.location.country.name')</th>
                                    <!-- <th>@lang('messages.location.country.phone_code')</th> -->
                              ...
                              <tr>
                                 ...
                                 <!-- <td>{{ucfirst($value->phone_code)}}</td> -->
                                 <td>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.location.country.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                          <a class="dropdown-item" href="{{route('admin.location.country.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
                              ...
                              @else
                              <tr>
                                 <td colspan="10">@lang('messages.location.country.not_found_country')</td>
                              </tr>
                              @endif
                           </table>
                        </div>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p class="mb-0">
               <strong>@lang('messages.location.country.are_you_sure_delete_country')</strong>
            </p>
         </div>
         <form action="{{route('admin.location.country.destroy')}}" method="POST">
            @csrf
...
$(document).ready(function(){
    $('.js-switch').change(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route('admin.location.country.country_status_update') }}',
            data: {'status': status, 'country_id': country_id, _token:token},
