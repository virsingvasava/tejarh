                     ...
                     <div class="card-body card-dashboard">
                        <div class="table-responsive">
                           <table class="table zero-configuration or-view">
                              <tbody>
                                 <tr>
                                    <th>@lang('messages.blog.title')</th>
                                    <td>{{ucfirst($view_blog->heading_title)}}</td>
                                 </tr>
                                 <tr>
                                    <th>@lang('messages.blog.sub_title')</th>
                                    <td>{{ucfirst($view_blog->subtitle_heading)}}</td>
                                 </tr>

                                 <tr>
                                    <th>@lang('messages.blog.description')</th>
                                    <td>{{ucfirst($view_blog->description)}}</td>
                                 </tr>

                                 <tr>
                                    <th>@lang('messages.blog.slug')</th>
                                    <td>{{$view_blog->slug}}</td>
                                 </tr>
                                 <tr>
                                    <th>@lang('messages.common.status')</th>
                                    <td>
                                       @if($view_blog->status == 1)
