            ...
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form  action="{{route('admin.blog.update')}}" enctype="multipart/form-data" method="post" id="blog_edit">
                           @csrf
                           ...
                           <div class="form-row">
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('heading_title') is-invalid @enderror" name="heading_title" id="heading_title" value="{{$edit_blog->heading_title}}" placeholder="@lang('messages.blog.title')">
                                    @error('heading_title')
                              ...
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('subtitle_heading') is-invalid @enderror" name="subtitle_heading" value="{{$edit_blog->subtitle_heading}}" placeholder="Sub Title">
                              ...
                              <div class="col-md-12 mb-12">
                                 <div class="d-block mb-1">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="Description">{{$edit_blog->description}}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                              ...
                              <div class="col-md-6 mb-6">
                                  <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" id="slug" placeholder="@lang('messages.branch.create.enter_slug')" value="{{$edit_blog->slug}}">
                                    @error('slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                              ...
                              <div class="col-md-6 mb-6">
                                 ...
                                 <fieldset class="form-group">
                                    <select class="custom-select @error('status') is-invalid @enderror" name="status">
                                       ...
                                       <option @if($edit_blog->status == 1) selected="selected" @endif value="1">@lang('messages.common.active')</option>
                                       <option @if($edit_blog->status == 0) selected="selected" @endif value="0">@lang('messages.common.In_active')</option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
