         ...
         <div class="row">
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     <a href="{{route('admin.role.create')}}" class="btn btn-light-primary btn-sm" data-repeater-create="" type="button">
                            ...
                            @endif
                              <thead>
                                 <tr>
                                    ...
                                    <th>@lang('messages.role.picture')</th>
                              ...
                              <tr>
                                 <td>#{{$key+1}}</td>
                                 <td>
                                    @if($value->role_picture != '' && file_exists(public_path('img/role_picture/'.$value->role_picture)))
                                    <img src="{{asset('img/role_picture/'.$value->role_picture)}}" style="height:40px; width: 40px;" alt="Picture" class="img-profile rounded-circle" />
                                    @else
                                    <img src="{{asset('img/category/placeholder.svg')}}" alt="Picture" style="height:40px; width: auto;" class="img-profile rounded-circle" />
                                    @endif
                                 </td>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.role.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> @lang('messages.common.view')</a>

                                          <a class="dropdown-item" href="{{route('admin.role.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> @lang('messages.common.edit')</a>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <p class="mb-0">
               <strong>@lang('messages.role.are_you_sure_to_delete_role')</strong>
            </p>
         </div>
...
$(document).ready(function(){
    $('.js-switch').change(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '{{ route('admin.role.role_status_update') }}',
            data: {'status': status, 'role_id': role_id, _token:token},
