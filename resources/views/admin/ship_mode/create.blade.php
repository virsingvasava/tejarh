      ...
      <div class="content-header row">
         <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
               <h5 class="content-header-title float-left pr-1 mb-0">@lang('messages.ship_mode.ship_mode')</h5>
               <div class="breadcrumb-wrapper d-none d-sm-block">
                  <ol class="breadcrumb p-0 mb-0 pl-1">
                     <li class="breadcrumb-item"><a href="/admin"><i class="bx bx-home-alt"></i></a>
                     </li>
                     <li class="breadcrumb-item"><a href="{{route('admin.ship_mode.index')}}">@lang('messages.ship_mode.ship_modes')</a>
                     </li>
                     <li class="breadcrumb-item active">@lang('messages.ship_mode.create.create')
                     </li>
                  </ol>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form  action="{{route('admin.ship_mode.store')}}" enctype="multipart/form-data" method="post" id="ship_mode_create">
                           @csrf
                           <div class="form-row">
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    <label for="name">@lang('messages.ship_mode.name')</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="@lang('messages.ship_mode.create.enter_name')">
                                    @error('name')
                              ...
                              <div class="col-md-6 mb-6">
                                 <div class="d-block mb-1">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="slug" id="slug" value="{{old('slug')}}" placeholder="@lang('messages.ship_mode.create.enter_slug')">
                                    @error('slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
