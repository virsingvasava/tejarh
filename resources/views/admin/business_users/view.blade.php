                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="user-profile-text">
                                ...
                                <small>{{ $user_business_view->company_legal_name }}</small> &nbsp;
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <ul class="list-unstyled bdetail">
                                                    <hr>
                                                    @if($user_business_view->owner_or_manager_name)
                                                    <li><i class="cursor-pointer bx bx-user mr-50"></i>Owner/Manager Name<div class="bd-detail-n">{{ $user_business_view->owner_or_manager_name }}</div></li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-users mr-50"></i>Owner/Manager Name <div class="bd-detail-n">N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->city_id)
                                                    <li><i class="cursor-pointer bx bx-map mr-50"></i>Location<div class="bd-detail-n">{{ $user_business_city_view->name }}</div></li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-map mr-50"></i>Location<div class="bd-detail-n">N/A</div></li>
                                                    @endif
                                                    ...
                                                    @endif
                                                    @if($user_business_view->enter_cr_number)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>CR Number
                                                        <div class="bd-detail-n">{{ $user_business_view->enter_cr_number }}  &nbsp;
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="cr_number_approved" class="js-switch cr-number" {{ $user_business_view->cr_number_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>CR Number <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->upload_cr)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>CR Upload File 
                                                        <a href="{{ route('admin.business_users.upload_cr_download',$user_business_view->upload_cr)}}" >
                                                            <i class="cursor-pointer bx bx-download mr-50" title="Download" ></i></a>
                                                        <a href="{{ asset('assets/users/'.$user_business_view->upload_cr) }}" target="_blank">View</a>
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="upload_cr_approved" class="js-switch cr-upload" {{ $user_business_view->upload_cr_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>CR Upload File <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->enter_cr_maroof_namber)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>CR Maroof Number
                                                        <div class="bd-detail-n">{{ $user_business_view->enter_cr_maroof_namber }}  &nbsp;
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="cr_maroof_no_approved" class="js-switch maroof-number" {{ $user_business_view->cr_maroof_no_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>CR Maroof Number <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->upload_maroof)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>CR Maroof File :  <a href="{{ route('admin.business_users.upload_manroof_download',$user_business_view->upload_maroof)}}" ><i class="cursor-pointer bx bx-download mr-50" title="Download" ></i></a><a href="{{ asset('assets/users/'.$user_business_view->upload_maroof) }}" target="_blank">View</a>
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="upload_maroof_approved" class="js-switch upload_maroof" {{ $user_business_view->upload_maroof_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>CR Maroof File <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->date_of_expiry)
                                                    <li><i class="cursor-pointer bx bx-calendar mr-50"></i>Date of Expiry <div class="bd-detail-n"> {{ $user_business_view->date_of_expiry }}</div></li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-calendar mr-50"></i>Date of Expiry <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->vat_number)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>VAT Number
                                                        <div class="bd-detail-n">{{ $user_business_view->vat_number }}  &nbsp;
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="vat_number_approved" class="js-switch vat-number" {{ $user_business_view->vat_number_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>VAT Number <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->vat_certificate_file)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>VAT Certificate :  <a href="{{ route('admin.business_users.vat_certificate_download',$user_business_view->vat_certificate_file)}}" ><i class="cursor-pointer bx bx-download mr-50" title="Download" ></i></a><a href="{{ asset('assets/users/'.$user_business_view->vat_certificate_file) }}" target="_blank">View</a>
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="vat_certificate_approved" class="js-switch vat_certificate" {{ $user_business_view->vat_certificate_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>VAT Certificate <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->ministry_of_government)
                                                    <li>
                                                        <i class="cursor-pointer bx bx-receipt mr-50"></i>Ministry of Government Certificate :  <a href="{{ route('admin.business_users.ministry_of_government_download',$user_business_view->ministry_of_government)}}" ><i class="cursor-pointer bx bx-download mr-50" title="Download" ></i></a><a href="{{ asset('assets/users/'.$user_business_view->ministry_of_government) }}" target="_blank">View</a>
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-id="{{ $user_business_view->id }}" name="ministry_of_government_approved" class="js-switch ministry_of_government" {{ $user_business_view->ministry_of_government_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-receipt mr-50"></i>Ministry of Government Certificate <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->bank_name)
                                                    <li><i class="cursor-pointer bx bx-home mr-50"></i>Bank Name <div class="bd-detail-n"> {{ $user_business_view->bank_name }}</div></li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-home mr-50"></i>Bank Name <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    @if($user_business_view->bank_account_number)
                                                    <li><i class="cursor-pointer bx bx-home mr-50"></i>Bank A/C Name <div class="bd-detail-n"> {{ $user_business_view->bank_account_number }}</div></li>
                                                    @else
                                                    <li><i class="cursor-pointer bx bx-home mr-50"></i>Bank A/C Name <div class="bd-detail-n"> N/A</div></li>
                                                    @endif
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-user-id="{{ $user_business_view->user_id }}" name="member_since_approved" class="js-switch member_since " id="member-since" {{ $user_view->member_since_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-user-id="{{ $user_business_view->user_id }}" name="quick_shipper_approved" class="js-switch quick_shipper" id="quick-shipper" {{ $user_view->quick_shipper_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="bd-detail-n">
                                                            <div class="custom-control custom-switch custom-switch-glow"> 
                                                                Approved : <input type="checkbox" data-user-id="{{ $user_business_view->user_id }}" name="reliable_approved" class="js-switch reliable" id="reliables" {{ $user_view->reliable_approved == 1 ? 'checked' : '' }}> 
                                                            </div>
                                                        </div>
                                                    </li>
...
<script type="text/javascript">
    ...
    let elems = Array.prototype.slice.call(document.querySelectorAll('.js-switch','js-switch cr-number'));
    ...
    $(document).ready(function(){
        $('.phone_number').change(function () {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.phone_verified")}}',
    ...
    $(document).ready(function(){
        $('.cr-number').change(function () {
            let cr_number_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_cr_number_id = $(this).data('id');
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.cr_number_verified")}}',
                data: {'cr_number_approved': cr_number_approved, 'user_cr_number_id': user_cr_number_id, _token:token},
                success: function (data) {
                    console.log(data.message);
                }
            });
    ...
    $(document).ready(function(){
        $('.cr-upload').change(function () {
            let upload_cr_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_cr_upload_id = $(this).data('id');
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.cr_upload_verified")}}',
                data: {'upload_cr_approved': upload_cr_approved, 'user_cr_upload_id': user_cr_upload_id, _token:token},
                success: function (data) {
                    console.log(data.message);
                }
            });
    ...
    $(document).ready(function(){
        $('.maroof-number').change(function () {
            var cr_maroof_no_approved = $(this).prop('checked') === true ? 1 : 0;
            var user_maroof_number_id = $(this).data('id');
            var token = "<?php echo csrf_token(); ?>";
            $.ajax({
                type: "POST",
                url: '{{ route("admin.business_users.cr_maroof_number_verified")}}',
                data: {'cr_maroof_no_approved': cr_maroof_no_approved, 'user_maroof_number_id': user_maroof_number_id, _token:token},
                success: function (data) {
                    console.log(data);
                }
            });
    ...
    $(document).ready(function(){
        $('#member-since').change(function () {
            let member_since_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_id =  $('.member_since').attr("data-user-id");
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.member_since_verified")}}',
    ...
    $(document).ready(function(){
        $('#quick-shipper').change(function () {
            let quick_shipper_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_id = $('.quick_shipper').attr("data-user-id");
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.quick_shipper_verified")}}',
    ...
    $(document).ready(function(){
        $('#reliables').change(function () {
            let reliable_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_id = $('.reliable').attr("data-user-id");
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.reliable_verified")}}',
    ...
    $(document).ready(function(){
        $('.upload_maroof').change(function () {
            let upload_maroof_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_upload_maroof_id = $(this).data('id');
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.upload_maroofr_verified")}}',
                data: {'upload_maroof_approved': upload_maroof_approved, 'user_upload_maroof_id': user_upload_maroof_id, _token:token},
                success: function (data) {
                    console.log(data.message);
                }
            });
    ...
    $(document).ready(function(){
        $('.vat-number').change(function () {
            let vat_number_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_vat_number_id = $(this).data('id');
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.vat_number_verified")}}',
                data: {'vat_number_approved': vat_number_approved, 'user_vat_number_id': user_vat_number_id, _token:token},
                success: function (data) {
                    console.log(data.message);
                }
            });
    ...
    $(document).ready(function(){
        $('.vat_certificate').change(function () {
            let vat_certificate_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_vat_certificate_id = $(this).data('id');
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.vat_certificate_verified")}}',
                data: {'vat_certificate_approved': vat_certificate_approved, 'user_vat_certificate_id': user_vat_certificate_id, _token:token},
                success: function (data) {
                    console.log(data.message);
                }
            });
    ...
    $(document).ready(function(){
        $('.ministry_of_government').change(function () {
            let ministry_of_government_approved = $(this).prop('checked') === true ? 1 : 0;
            let user_mog_certificate_id = $(this).data('id');
            var token = "{{csrf_token()}}";
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '{{ route("admin.business_users.mog_certificate_verified")}}',
                data: {'ministry_of_government_approved': ministry_of_government_approved, 'user_mog_certificate_id': user_mog_certificate_id, _token:token},
                success: function (data) {
                    console.log(data.message);
                }
            });
