            ...
            <div class="col-12">
               <div class="form-group">
                  <div class="col p-0">
                     ...
                     <span class="invoice-repeat-btn">Add Category</span>
                     </a>
                  </div>
               </div>
            </div>
                                 ...
                                 <td>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="{{route('admin.category.view',base64_encode($value->id))}}"><i class="bx bx-show-alt mr-1"></i> View</a>

                                          <a class="dropdown-item" href="{{route('admin.category.edit',base64_encode($value->id))}}"><i class="bx bx-edit-alt mr-1"></i> edit</a>

                                          <a href="javascript:void(0)" class="dropdown-item tejarh_delete_button" data-toggle="modal" data-target="#tejarhDeleteModel" data-id="{{$value->id}}"><i class="bx bx-trash mr-1"></i>Delete</a>
   ...
   <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="tejarhModalCenterTitle">Are You sure?</h5>
         ...
         <form action="{{route('admin.category.destroy')}}" method="POST">
            ...
            <div class="modal-footer">
               ...
               <span class="d-none d-sm-block"><strong>Close</strong></span></button>
               <button type="submit" class="btn btn-light-primary ml-1"> <i class="bx bx-check d-block d-sm-none"></i>
               <span class="d-none d-sm-block"><strong>Delete</strong></span></button>
            </div>
         </form>
      </div>
   </div>
