        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 justify-content-end d-flex">
                    <a href="{{ route('frontend.users.user-support.reaquested_list') }}" class="btn return-order-list">Requested Ticket</a>
                </div>
            </div>
            <div class="row">
                    ...
                    <table id="pagingBox">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="view">
                                    <a href="{{ route('frontend.users.user-support.ticket_details', ($value['id'])) }}"><i class="fas fa-eye"></i></a>
                                </td>
                                <td class="remove">
                                    @if($value['status'] == '0')
                                    <h5>Open</h5>
