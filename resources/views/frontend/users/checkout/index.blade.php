...
@section('title','Tejarh - User Cart')
@section('content')
                ...
                <div class="shopping-cart">
                    ...
                    <table class="carttable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="{{ route('frontend.users.order-details.removed-item',$item['id']) }}" style="color:#F05454;"><i class="fas fa-trash"></i></a></td>
                    ...
                    ?>
                        <div class="check_qty">
                            <div class="totals">
                                <!-- <div class="totals-item">
                                    <label> @lang('frontend-messages.cart.tax') ({{ env('BUY_ITEMS_TEXT') }}%)</label>
                                    <div class="totals-value" id="cart_tax">00.00 {{ env('CURRENCY_TAG') }}</div>
                                </div> -->
                                <div class="totals-item">
                                    <label> @lang('frontend-messages.cart.shipping')</label>
                                ...
                                <div class="totals-item totals-item-total">
                                    <label> @lang('frontend-messages.cart.grand_total')</label>
                                    <?php
                            ...
                            <div class="product-box-btn">
                                <a href="{{ route('frontend.users.order-details.orderPaymentChoose',$checkOutUserId['id']) }}" class="btn" style="width:27em">@lang('business_messages.cart.checkout')</a>
                            </div>
                        </div>
                    <?php
                    }
...
<link rel="stylesheet" href="{{ asset('fronted/users_flow/assets/css/cart_css.css') }}">
<link rel="stylesheet" href="{{ asset('fronted/users_flow/assets/css/checkout_style.css') }}">
