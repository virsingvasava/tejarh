            ...
            <table id="pagingBox">
                ...
                <tbody>
                    <tr>
                        ...
                        @if ($condition->name == NEW_ITEMS)
                        <td><a href="{{ route('frontend.users.new-items.product_details', ($item->id)) }}"><i class="fas fa-eye"></i></a></td>
                        @elseif ($condition->name == USED_ITEMS)
                        <td><a href="{{ route('frontend.users.used-items.product_details', ($item->id)) }}"><i class="fas fa-eye"></i></a></td>
                        @elseif ($condition->name == UNUSED_ITEMS)
                        <td><a href="{{ route('frontend.users.unused-items.product_details', ($item->id)) }}"><i class="fas fa-eye"></i></a></td>
                        @endif
                    </tr>
                </tbody>
                <?php $i++; ?>
