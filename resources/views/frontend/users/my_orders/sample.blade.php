                ...
                <div class="right-order-summary-payment pay-checkout">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('frontend.users.order-details.order_placed') }}" id="payment-form">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="input-group card-date">
                                            <input type="text" placeholder="MM" name="expiry_month" maxlength="2" minimum="2" class="form-control">556df6dsf
                                            <input type="text" placeholder="YY" name="expiry_year" maxlength="2" minimum="2" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group submit">
                                    <button type="submit"  class="btn btn-primary"  value="Make Payment">@lang('frontend-messages.card.pay') {{$cart_price->total_amount}}</button>
                                </div><br>
                            </form>
                        </div>
                    </div>
