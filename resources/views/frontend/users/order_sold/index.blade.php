        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 justify-content-end d-flex">
                    <a href="{{ route('frontend.users.orders-sold.return_order') }}" class="btn return-order-list">Return Order List</a>
                </div>
            </div>
            <div class="row">
                ...
                <div class="my-orders-filter">
                    ...
                    <!-- <div class="my-orders-filter-box">
                            ...
                            <div class="form-check">
                                <input class="form-check-input order_status" type="checkbox" value="" name="order_status">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.create_shipping').click(function() {
            ...
            $.ajax({
                url: '{{route("frontend.users.orders-sold.create_shipping")}}',
                type: "POST",
                dataType: "json",
                data: {
                    'item_id': item_id,
...
<script>
    $('.orderFilter').click(function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "html",
            url: '{{ route("frontend.users.orders-sold.orderFilter") }}',
            data: {
...
<script>
    $('.last_30_DaysOrderFilter').click(function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "html",
            url: '{{ route("frontend.users.orders-sold.last_30_DaysOrderFilter") }}',
            data: {
                'last_30_days_orders': last_30_days,
                _token: token
            },
