                ...
                <div class="right-order-summary-payment pay-checkout rosp">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('frontend.users.profile.payment_successfull',$storyPriceId) }}" 
                            id="usersPaymentCardForm">
                                ...
                                <div class="form-group submit">
                                    <button type="submit"  class="btn btn-primary" 
                                     value="Make Payment">@lang('frontend-messages.card.pay') {{$storyPriceIdDetails->product_price}}</button>
                                </div><br>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    function onCardTokenized(event) {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('frontend.users.profile.payment_successfull',$storyPriceId) }}",
            data: {
                'token': payment_token,
