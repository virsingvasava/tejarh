                ...
                <div class="right-order-summary-payment pay-checkout rosp">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            @endif
                            <h5>Add Card</h5>
                            <form method="POST" action="{{ route('frontend.users.boost-items.boost_items_payment_info') }}" id="usersPaymentCardForm">
                                @csrf
...
<script>
    ...
    function onCardTokenized(event) {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('frontend.users.boost-items.boost_items_payment_info') }}",
            data: {
                'token': payment_token,
