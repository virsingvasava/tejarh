...
@section('title','Tejarh - User New Items')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="my-items-filter">
                        <h5>@lang('frontend-messages.conditions.new_items')</h5>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row" id="pagingBox">
                    @if (Auth::check())
                        @if (!empty($newItemsArray) && count($newItemsArray) > 0)
                            @foreach ($newItemsArray as $key => $item)
                                <div class="col-md-3">
                                    <div class="products-box">
                                        <div class="products-box-img">
                                            <a
                                                href="{{ route('frontend.users.new-items.item_details', ($item['id'])) }}">
                                        ...
                                        <div class="products-box-content">
                                            ...
                                            <div class="products-box-footer">
                                                @if ($item['user']['role'] == USER_ROLE)
                                                      ...
                                                      @if ($item['user']['profile_picture'] != "" && file_exists('assets/users/'.$item['user']['profile_picture']))
