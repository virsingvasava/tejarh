        ...
        <div class="container">
                ...
                <div class="col-md-5">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('frontend-messages.conditions.unused_items')</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-7">
                    <div class="my-items-filter">
                        <h5>@lang('frontend-messages.conditions.unused_items')</h5>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="products-wrapper">
                <div class="row" id="pagingBox">
                    @if (Auth::check())
                        @if (!empty($unusedItemsArray) && count($unusedItemsArray) > 0)
                            @foreach ($unusedItemsArray as $key => $item)
                                <div class="col-md-3">
                                    <div class="products-box">
                                        <div class="products-box-img">
                                            <a
                                                href="{{ route('frontend.users.unused-items.item_details', ($item['id'])) }}">
