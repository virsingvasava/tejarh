...
@section('title','Tejarh - Product Reviews')
@section('content')
                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Product-Reviews</li>
                            {{-- <li class="breadcrumb-item" aria-current="page">List of Reviews</li> --}}
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('frontend.users.product_category.index', $id)}}">{{ $category_name->category_name }}</a></li>
                    ...
                    <div class="user_review_message_section">
                        ...
                        @else
                            <div class="text-center mt-5">
                                <h6>Not Found Product Reviews</h6>
                            </div>
                        @endif
                    </div>
                </div>
