                ...
                <div class="col-md-5">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('frontend-messages.conditions.promoted_items')</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-7">
                    <div class="my-items-filter">
                        <h5>@lang('frontend-messages.conditions.promoted_items')</h5>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="products-box">
                                        <div class="products-box-img">
                                            <a href="{{ route('frontend.users.promoted-items.item_details', $item['item']['id']) }}">
                                                @if (!empty($item['boostItem']['item_id']))
                                                    @if ($item['item']['id'] == $item['boostItem']['item_id'])
                                        ...
                                        <div class="products-box-content">
                                            ...
                                            @endif
                                            <h6><img src="{{ asset(USERS_ASSETS_FOLDER . '/images/sar-tag.png') }}"> {{ $item['item']['price'] }} {{env('CURRENCY_TAG')}}</h6>
                                            <p>{{ $item['brand']['name'] }}</p>
