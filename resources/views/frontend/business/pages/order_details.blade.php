        ...
        <div class="row">
            <div class="col-md-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('frontend.business.home.index')}}"><i class="fas fa-home"></i> @lang('business_messages.order-details.home')</a></li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('business_messages.order-details.order_details')</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-6">
                ...
                <a href="{{ route('frontend.business.order-details.pdf_download_invoice', ($orderDetails['id'])) }}" class="btn tras_btn">Tax Invoice</a>
                @else
                <a href="{{ route('frontend.business.order-details.pdf_download_invoice', ($orderDetails['id'])) }}" class="btn tras_btn">Proforma Invoice</a>
                @endif
                <a id="returnbtn" class="btn checkbox_button" width="50px" height="25px" style="display:none;" data-id="">Return Order</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="order-detail">
                    <ul>
                        <li>@lang('business_messages.order-details.order_id') : #{{ $orderDetails['id'] }}</li>
                        @php
                        $create_date = date('d M Y', strtotime($orderDetails['created_at']));
                        @endphp
                        <li>@lang('business_messages.order-details.date') : {{$create_date}}</li>
                    </ul>
                    <div class="order-detail-content buisness-order">
                        <div class="delivery-address">
                            ...
                            <p>@lang('business_messages.order-details.phone') :<a href="tel:{{ $orderAddress->phone_number }}">{{ $orderAddress->phone_number }}</a></p>
                        </div>
                        <div class="payment-method">
                            <h6>@lang('business_messages.order-details.payment_method')</h6>
                            <?php
                        ...
                        <div class="payment-details">
                            <h6>@lang('business_messages.order-details.payment_details')</h6>
                            <table>
                                <tr>
            ...
            <div class="col-md-12">
                ...
                <div class="order-select-wrapper">
                    <div class="order-product">
                        ...
                        <div class="form-check order-checkbox"><input type="checkbox" class="form-check-input custom-checkbox order_checkbox checkbox" data-id="" type="checkbox" value="" data-orderIds="{{ $value['orderItems']['id'] }}" id="flexCheckChecked" style="width: 1.5em;height: 1.5em;"></div>
                        @endif
                        @if (isset($value['itemImage']['item_picture1']) && !empty($value['itemImage']['item_picture1']))
                        <img src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $value['itemImage']['item_picture1']) }}">
                        @else
                ...
                <div class="order-select-wrapper">
                    <div class="order-product">
                        ...
                        <img src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $retunValue['itemImage']['item_picture1']) }}">
                        @else
                        <img src="{{ asset('fronted/users_flow/assets/images/no-image.png') }}">
                        @endif
                        <div class="order-product-content">
    ...
    $(document).ready(function() {
        $(".checkbox_button").on("click", function(e) {
            ...
            if (
                ...
                var ids = strIds;
                $.ajax({
                    url: "{{ route('frontend.business.order-details.order_return') }}",
                    type: "POST",
                    dataType: "json",
                    data: {
                    _token: token,
