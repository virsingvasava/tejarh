                ...
                <div class="right-order-summary-payment pay-checkout">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('frontend.business.business-profile.payment_successfull',$storyPriceId) }}" 
...
<script>
    ...
    function onCardTokenized(event) {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('frontend.business.business-profile.payment_successfull',$storyPriceId) }}",
            data: {
                'token': payment_token,
