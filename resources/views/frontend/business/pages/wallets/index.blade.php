            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">@lang('business_messages.wallet.my_account')</li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('business_messages.wallet.my_wallet')</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-4">
...
<div class="modal fade" id="add-card-payment" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('frontend.business.business-wallet.wallet_paid') }}" method="POST" id="paymentCardForm">
                @csrf
...
<script type="text/javascript">
    $(".clickable").click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('frontend.business.business-wallet.store') }}",
            data: {
                amount: amount,
                _token: token
            },
