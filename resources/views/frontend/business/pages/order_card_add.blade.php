                ...
                <div class="right-order-summary-payment pay-checkout">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            @endif
                            <h5>Add Card</h5>
                            <form method="POST" action="{{ route('frontend.business.order-details.order_placed') }}" id="payment-form">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="input-group card-date">
                                            <input type="text" placeholder="MM" name="expiry_month" maxlength="2" minimum="2" class="form-control">
                                ...
                                <div class="form-group submit">
                                    <button style="width:100%" type="submit"  class="btn"  value="Make Payment">Pay {{$cart_price->total_amount}}</button>
                                </div><br>
                            </form>
                        </div>
                    </div>
