            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Request-Ticket</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                    ...
                    <table id="pagingBox">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="view">
                                    <a href="{{ route('frontend.business.user-support.received_details', ($value['id'])) }}"><i class="fas fa-eye"></i></a>
                                </td>
                                <td class="remove">
                                    @if($value['status'] == '0')
                                    <h5>Open</h5>
