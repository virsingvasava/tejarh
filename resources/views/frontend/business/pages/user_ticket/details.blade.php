            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">User-Support-Details</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-12">
                        ...
                        <div class="reply-input-group">
                            <div class="reply-file-upload-g">
                                <div class="reply-file-upload">
                                    <input type="file" name="image" id="image" accept="application/pdf,image/png,image/jpg,image/jpeg" class="valid" aria-invalid="false">
                                    Add Attachment
                                </div>
                            </div>
        ...
        $("#ticketModal").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    contentType: false,
                    url: '{{ route("frontend.business.user-support.add_reply") }}',
                    data: formdata,
