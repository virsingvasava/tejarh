                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="javascript:void(0)">Seller</a></li>
                                    ...
                                    <div class="seller-review-section-content">
                                        <div class="profile-seller-img">
                                            @if (!empty($sellerDetails['profile_picture']))
                                                <img class="seller_profile"
                                                    src="@if (isset($sellerDetails['profile_picture'])) {{ asset(BUSINESS_PROFILE_FOLDER . '/' . $sellerDetails['profile_picture']) }} @endif">
                                            @else
