                ...
                <div class="col-md-5">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('business_messages.conditions.unused_items')</li>
                        </ol>
                    </nav>                                        
                </div>
                <div class="col-md-7">
                    <div class="my-items-filter">
                        ...
                        <h5>@lang('business_messages.conditions.unused_items')</h5>
                    </div>                                    
                </div>
            </div>
            <div class="row">                                   
                @if(!empty($unusedItemsArray) && count($unusedItemsArray) > 0)
                    @foreach($unusedItemsArray as $key => $value)
                        <div class="col-md-3">
