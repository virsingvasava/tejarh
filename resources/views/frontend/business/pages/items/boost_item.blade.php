...
@section('content')
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">{{ $value['what_are_you_selling'] }}</li>                                
                                </ol>
                            </nav>                                        
                        </div>
                        <div class="col-md-8">
                            <div class="product-slider">
                                ...
                                <div id="product-slider1" class="owl-carousel owl-theme">
                                    ...
                                    @if (isset($value['item_pictures']['item_picture2']) && !empty($value['item_pictures']['item_picture2']))
                                        <div class="item">
                                            <img
                                                src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $value['item_pictures']['item_picture2']) }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (isset($value['item_pictures']['item_picture3']) && !empty($value['item_pictures']['item_picture3']))
                                        <div class="item">
                                            <img
                                                src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $value['item_pictures']['item_picture3']) }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (isset($value['item_pictures']['item_picture4']) && !empty($value['item_pictures']['item_picture4']))
                                        <div class="item">
                                            <img
                                                src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $value['item_pictures']['item_picture4']) }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (isset($value['item_pictures']['item_picture5']) && !empty($value['item_pictures']['item_picture5']))
                                        <div class="item">
                                            <img
                                                src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $value['item_pictures']['item_picture5']) }}">
                                        </div>
                                    @endif
                                    ...
                                    @if (isset($value['item_pictures']['item_picture6']) && !empty($value['item_pictures']['item_picture6']))
                                        <div class="item">
                                            <img
                                                src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $value['item_pictures']['item_picture6']) }}">
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-4">    
                            <div class="product-details-right-side">
                                ...
                                @endphp
                                    ...
                                    <a href="javascript:void(0)" class="btn get_items_id" data-id="{{$value['id']}}" data-bs-toggle="modal" data-bs-target="#boost-item">Boost Item</a></li>
                                </div>
                            </div>  
                            <div class="related-product-list">

                                @if(!empty($boostItemArray) && count($boostItemArray) > 0)
                                    <h4>Boosted Items <a href="javascript::void(0)">View More</a></h4>
                                @else
                                   <h4>Boosted Items <a href="javascript::void(0)" style="pointer-events:none;">View More</a></h4>
                                @endif
                                                ...
                                                <div class="products-box">
                                                    <div class="products-box-img">
                                                        ...
                                                        @if (isset($item_images['item_picture1']) && !empty($item_images['item_picture1']))
                                                            <div class="item">
                                                                <img
                                                                    src="{{ asset(BUSINESS_ITEMS_POST_FOLDER . '/' . $item_images['item_picture1']) }}">
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div class="products-box-content">
                                                        ...
                                                        @endif
                                                        <h6><img src="{{ asset(BUSINESS_ASSETS_FOLDER . '/images/img/sar-tag.png') }}"> {{ $boostItems->boost_amount }} {{env('CURRENCY_TAG')}}</h6>
        ...
        <div class="related-ads-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h4>@lang('business_messages.postDetails.related_ads') <a href="#">@lang('business_messages.postDetails.view_more')</a></h4>
                    </div>
        ...
        <div class="modal fade" id="boost-item" tabindex="-1"  aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <button type="button" class="btn-close popup-close" data-bs-dismiss="modal" aria-label="Close"></button>                    
                    ...
                    <p><a href="javascript:void(0)" data-id="" class="btn make_payment" id="set_item_id">Pay Now</a></p>
