    ...
    <div class="my-items-wrapper">
        <div class="container">
            ...
            <div class="col-md-8 offset-2 mt-5">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ route('frontend.business.profile.edit_term_condition',$check_term_condition->id) }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{$check_term_condition->id}}">
                            <div class="form-group">
                                <label><strong>Edit Description :</strong></label><br>
                                <textarea class="ckeditor form-control" name="description" value="{{$check_term_condition->description}}" >{!! Request::old('content', $check_term_condition->description) !!}</textarea>
                            </div><br>
            ...
            <div class="col-md-8 offset-2 mt-5">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ route('frontend.business.profile.add_term_condition') }}" id="policy_create" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
