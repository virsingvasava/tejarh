...
class ProductCategoryController extends Controller
{
    public function index($id)
    {
        ...
        $categories = DB::table('category')
                      ->select('id', 'category_name', 'ar_category_name')
                      ->get();

        $sub_categories = DB::table('sub_category')
                            ->select('id', 'sub_cate_name','ar_sub_cate_name', 'category_id')
        ...
        $locations = DB::table('cities')->select('id', 'name', 'ar_name')->get();
        $minprice = DB::table('items')->where('category_id','=',$id)->min('price');
        $maxprice =  DB::table('items')->where('category_id','=',$id)->max('price');
        
        return view('frontend.business.pages.items.category.index', compact('id',
        'usedItemsArray',
        'cate_name',
        'categories',
        'sub_categories', 
    ...
    public function subCateFilter(Request $request)
    {
        ...
        return view('frontend.business.pages.items.category.cate_filter', compact('cateFilterArray', 'category'));
