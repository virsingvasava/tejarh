...
class UserTicketController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.business.pages.user_ticket.index',compact('itemArray'));
    }
    ...
    public function ticket_details(Request $request)
    {
        ...
        return view('frontend.business.pages.user_ticket.details',compact('itemArray'));
    }
    ...
    public function reaquested_list()
    {
        ...
        return view('frontend.business.pages.user_ticket.requested_list',compact('itemArray'));
    }
    ...
    public function received_details(Request $request)
    {
        ...
        return view('frontend.business.pages.user_ticket.received_details',compact('itemArray'));
    }
}
