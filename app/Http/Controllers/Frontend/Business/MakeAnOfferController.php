...
class MakeAnOfferController extends Controller
{
    public function make_an_offer_post(RequestValidation $request){
        ...
        return redirect()->route('frontend.business.promoted-items.item_details', base64_encode($id))->with('success', __('business_messages.make_an_offer.success.make_an_offer_send_successfully'));
