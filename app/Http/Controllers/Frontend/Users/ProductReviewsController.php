...
class ProductReviewsController extends Controller
{
    ...
    {  
        ...
        return view('frontend.users.pages.product_review.index', compact('reviewRatings'));
    ...
    public function reviews_details($id)
    {
        ...
        return view('frontend.users.pages.product_review.index', compact('id','itemImage','itemArray', 'category_name', 'item_name'));
    }
