...
class WishlistController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.users.wishlist.index', compact('user', 'itemArray'));
    }
    ...
    public function add_to_wishlist(Request $request)
    {
        ...
        if (!empty($checkWishlist)) {
            ...
            $wishlist_update = Wishlist::where(['item_id' => $request->item_id])->first();
            ...
            if ($wishlist_update->wishlist_status == 0) {
                ...
                return response()->json(['status' => 0, 'code' => 200, 'success' => Lang::get('Product is Added to Favorite Successfully !')], 200);
            }else {
                return response()->json(['status' => 1, 'code' => 200, 'success' => Lang::get('Product is Remove to Favorite Successfully !')], 200);
            }
        } else {
            ...
            $wishlist->save();
            return response()->json(['status' => $wishlist->wishlist_status, 'code' => 200, 'success' => Lang::get('Product is Remove to Favorite Successfully !')], 200);
        }
    }
