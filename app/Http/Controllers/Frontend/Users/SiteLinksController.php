...
class SiteLinksController extends Controller
{
    public function aboutUs(){
        ...
        return view('frontend.users.site_links.about_us',compact('about_us_title','about_us_des'));
    }

    public function location(){
        return view('frontend.users.site_links.location');
    }

    public function couponsOffers(){
        return view('frontend.users.site_links.couponsOffers');
    }
    ...
    public function contactUs(){
        ...
        return view('frontend.users.site_links.contactUs',compact('contact_us_title','contact_us_des'));
    }

    public function careers(){
        $careers_title = CmsPage::where('slug','=','careers')->first();
        $careers_des = CmsPage::where('slug','=','careers')->where('status',1)->first();
        return view('frontend.users.site_links.careers',compact('careers_title','careers_des'));
    }

    public function faq(){

        $faqArray = Faq::where('status', TRUE)->get(); 
        return view('frontend.users.site_links.faq', compact($faqArray));
    }
    ...
    public function termsCondition(){
        ...
        return view('frontend.users.site_links.termsCondition',compact('termsCondition_title','termsCondition_des'));
    }
    ...
    public function termsOfUse(){
        ...
        return view('frontend.users.site_links.terms_of_use',compact('termsOfUse_title','termsOfUse_des'));
    }
    ...
    public function trackOrder(){
        ...
        return view('frontend.users.site_links.trackOrder',compact('track_Order_tital','trackOrder_des'));
    }

    public function shipping(){
        $shipping_title = CmsPage::where('slug','=','shipping')->first();
        $shipping_des = CmsPage::where('slug','=','shipping')->where('status',1)->first();
        return view('frontend.users.site_links.shipping',compact('shipping_title','shipping_des'));
    }
    ...
    public function cancellation(){
        ...
        return view('frontend.users.site_links.cancellation',compact('cancellation_title','cancellation_des'));
    }
    ...
    public function returnOrder(){
        ...
        return view('frontend.users.site_links.returnOrder',compact('returnorder_title','returnorder_des'));
    }

    public function whitehat(){
        return view('frontend.users.site_links.whitehat');
    }

    public function blog(){
        return view('frontend.users.site_links.blog');
    }
    ...
    public function privacyPolicy(){
        ...
        return view('frontend.users.site_links.privacyPolicy',compact('privacyPolicy_title','privacyPolicy_des'));
    }

    public function siteMap(){
        $sitemap_title = CmsPage::where('slug','=','site_map')->first();
        $sitemap_des = CmsPage::where('slug','=','site_map')->where('status',1)->first();
        return view('frontend.users.site_links.siteMap',compact('sitemap_title','sitemap_des'));
    }

    public function supportPage(){
        return view('frontend.users.site_links.support');
    }
}
