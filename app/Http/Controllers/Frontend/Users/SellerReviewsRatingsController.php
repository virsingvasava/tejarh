...
class SellerReviewsRatingsController extends Controller
{
    ...
    {  
        ...
        return view('frontend.users.pages.seller_reviews.index', compact('reviewRatings'));
    ...
    public function seller_reviews_details($id)
    {
        ...
        return view('frontend.users.pages.seller_reviews.index', compact('sellerDetails', 'reviewRatingArray', 'profileArrayBussiness'));
    }
