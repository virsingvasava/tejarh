...
class BoostItemsController extends Controller
{
    ...
    {   
        return view('frontend.users.pages.user_boost_item');
    }
    ...
    public function item_details($id)
    {
        ...
        $relatedItemArray = [];
        foreach($relatedAdsitemsList as $key => $value)
        {
        ...
        return view('frontend.users.pages.user_boost_item', compact('itemArray', 'boostItemArray', 'relatedItemArray'));
    }
    ...
    public function boost_items_payment(Request $request , $id){
        ...
        return view('frontend.users.pages.user_boost_item_payment' , compact('boostData','monthArray'));
    }
