...
class CustomerOrder extends Controller
{
    public function index()
    {
        ...
        return view('frontend.users.order_sold.index', compact('itemArray'));
    }
    ...
    public function orderFilter(Request $request){
        ...
        return view('frontend.users.order_sold.order_filter_date', compact('arrayFilter'));
    ...
    public function return_order()
    {
        ...
        return view('frontend.users.order_sold.return_order', compact('itemArray'));
    }
